...
def get_args():
    ...
    # parser.add_argument('--load_checkpoint_one_out', default = False, type = bool, required = False)
    # parser.add_argument('--record_queries', default = True, type = bool, required = False)
    # parser.add_argument('--leave_one_out_train', default = False, type = bool, required = False)
    parser.add_argument('--rgb', default = False, type = bool, required = False)
